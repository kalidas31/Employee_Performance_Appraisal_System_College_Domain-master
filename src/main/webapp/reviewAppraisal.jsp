...
<html>
<head>
    <title>Review Appraisal</title>
     <link rel="stylesheet" href="RAstyles.css">
</head>
<body>
    ...
    <form action="ReviewServlet" method="post">
        ...
        <fieldset>
            <legend>HOD Remarks</legend>
            <textarea id="hodRemarks" name="hodRemarks"><%= appraisals.getHodRemarks() %></textarea>
        </fieldset>
        <br>
